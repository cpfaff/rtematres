...
#'
#' Features the tasks of the tematres server api. With no sugar added.
#' They are the basic building blocks for more convenient user functions.
#'
#' @param task The api task you like to perform. Use the the task "availableTasks"
...
#'        about the type of arguments when you call the task "availableTasks".
#'        It depends on the task if the argument is numeric or a character.
#'
#' @return The function returns either a dataframe for "availableTasks" or a list
#'         of information elements for a certain task.
#'
#' @examples \dontrun{
