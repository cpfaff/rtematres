...
representations of knowledge on any [tematres
server](http://www.vocabularyserver.com/) instance. It gives you access to the
base API functions and their documentation and offers convenient wrapper
functions that ease the explotion of the vocabolary.
...
that begin with the letter. As you see there is a subsetting done. This is
because of the function returns are more verbose.


```r
rtematres.search(term = "plant")$term
```
...
```r
rtematres.define("plant organ")$note_text
```
...
```
## Error: could not find function "annotate.dataframe"
```
